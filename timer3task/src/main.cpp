/*
Code chay 3 task + 1 timer. Luu y khong nen thay doi bat cu thong so nao lien quan den stack size cua tung task.
*/
/*Thu vien cho cac task............................................................................................................................*/
#include <SPI.h>
#include <Wire.h>
...
void initial(){
  ...
  setTime(17, 5, 45, 4, 15, 11, 23); // 9:0:45 t7 28-10-2023
}
...
void task1(void *pvPara){
  while(1){
    LCD();
    vTaskDelay(pdMS_TO_TICKS(1000)); //pdMS_TO_TICKS: Dung de doi so tick tuong ung voi 1000ms 
  }
}
/*Task3 ver 1: Cho RTC va DHT11 chay chung....................................................................................................*/
void task3_ver1(){
  while(1){
  readDS1307();
  digitalClockDisplay();
...
void setup()
{
  ...
  /*Khoi tao software timer voi cac he so: Ten timer (Dung cho debug), Chu ky cua timer, set pdTrue de timer co the chay theo chu ky,Id de tinh so lan timer di het 1 chu ky,
  Ham goi khi timer chay het 1 chu ky......................................................................................................................................*/
  /*timer = xTimerCreate("LED Timer", pdMS_TO_TICKS(1000), pdTRUE, 0, task3_ver2); //runRTC
  ...
  */
  ...
  xTaskCreate(task2,"NEO LED",140,NULL,1,NULL);
  xTaskCreate(task4,"DHT", 140, NULL,1,NULL);
